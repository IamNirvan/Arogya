...
<main class="app-main">
    <?php
        if($_SESSION["accountType"] == "receptionist") {
            ...
            $columnNames1 = ["ID", "Start date", "End date", "Start time", "End time", "Room ID", "Patient ID",
                "Status"];
            $attributes1 = ["occupancyID", "startDate", "endDate", "startTime", "endTime", "roomID", "patientID",
                "occupancyStatus"];
            addTable(columnNames: $columnNames1, attributes: $attributes1, query:$tableDataQuery,
                title:"Patient Room Bookings", size:"largeBox", addItemPage: "addPatientRoomOccupancy.php",
                deleteLink: "deletePatientRoomOccupancy.php", updateLink: "updatePatientRoomOccupancy.php",
