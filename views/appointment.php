    ...
    <?php
        if($_SESSION["accountType"] == "receptionist") {
            ...
            addTable(columnNames: $columnNames1, attributes: $attributes1, query:$tableDataQuery,
                ...
                deleteLink: "deleteAppointment.php", updateLink: "updateAppointment.php",
            ...
            if(isset($_GET["searchButton"])) {
                ...
                $tableDataQuery = "SELECT * FROM appointment WHERE employeeID = '$doctorID'
                                AND appointmentStatus = 'open';";
            }
            $columnNames1 = ["ID", "Date", "Start time", "End time", "Patient ID"];
            $attributes1 = ["appointmentID", "bookedDate", "startTime", "endTime", "patientID"];
            addTable(columnNames: $columnNames1, attributes: $attributes1, query:$tableDataQuery,
                title:"Open Appointments", size:"extraLargeBox", manageLink: "manageAppointment.php");
            echo '</div>';
        }
    ?>
</main>
