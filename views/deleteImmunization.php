...
?>
    <main class="app-main">
        <div class="container">
            <div class="heading">
                <h3>Delete Immunization [<?php echo $recId?>]?</h3>
            </div>
            <!-- This allows the record ID to be passed into the delete control handler.-->
            <form action="../controllers/deleteImmunizationHandler.php?ID=<?php echo $recId?>" method="POST"
                  autocomplete="off">
