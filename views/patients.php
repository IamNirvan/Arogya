    ...
    <?php
        if($_SESSION["accountType"] == "receptionist") {
            ...
            addTable(columnNames: $columnNames1, attributes: $attributes1, query:$tableDataQuery,
                title:"Admitted patients", size:"largeBox", viewLink: $_SERVER['PHP_SELF']);
            echo '</div>';
        }
            ...
            if(isset($_GET["ID"])) {
                ...
                addTable(columnNames: $columnNames1, attributes: $attributes1, query:$query1,
                    title:"Allergies", size:"smallBox");
                ...
                addTable(columnNames: $columnNames2, attributes: $attributes2, query:$query2,
                    title:"Examinations", size:"smallBox");
                ...
                addTable(columnNames: $columnNames3, attributes: $attributes3, query:$query3,
                    title:"Immunizations", size:"smallBox");
                ...
                addTable(columnNames: $columnNames4, attributes: $attributes4, query:$query4,
                    title:"Surgeries", size:"smallBox");
            }
            echo '</div>';
        }
    ?>
