...
<main class="app-main">
    ...
    <div class="container">
        <form action="../controllers/updateAppointmentHandler.php?ID=<?php echo $recId;?>" method="POST"
              autocomplete="off">
            <div id="mainSection">
                <div class="formSection">
                    <label class="inputLabel" for="datePicker">Date</label>
                    <br>
                    <input type="date" id="datePicker" name="date" value="<?php
                        echo $globalFetch["bookedDate"];
                    ?>" required>
                    <br>
                ...
                <div class="formSection">
                    ...
                    <br>
                    <input type="time" id="startTimePicker" name="startTime" value="<?php
                        echo $globalFetch["startTime"];
                    ?>" required>
                    <br>
                ...
                <div class="formSection">
                    ...
                    <br>
                    <input type="time" id="endTimePicker" name="endTime" value="<?php
                        echo $globalFetch["endTime"];
                    ?>" required>
                    <br>
                ...
                <?php if($_SESSION["accountType"] == "receptionist") {
                    ?>
                    <div class="formSection">
                        <label class="inputLabel" for="patientIDs">Patient ID</label>
                        <br>
                        <select name="patientIDs" id="patientIDs">
                            <?php
                            $query = "SELECT
                                        patientID,
                                        firstName,
                            ...
                            while($fetched = mysqli_fetch_assoc($rawData)) {
                                ...
                                if($patientID == $globalFetch["patientID"]) {
                                    echo "<option value=$patientID selected>[$patientID] $firstName 
                                            $lastName</option>";
                                }
                                else {
                ...
                <div class="formSection">
                    <label class="inputLabel" for="doctorIDs">Doctor ID</label>
                    <br>
                    <select name="doctorIDs" id="doctorIDs">
                        <?php
                     ...
                     specialization ='administrator' AND NOT specialization ='receptionist';";
                        ...
                        while($fetched = mysqli_fetch_assoc($rawData)) {
                            ...
                            if($employeeID == $globalFetch["employeeID"]) {
                                echo "<option value=$employeeID selected>$employeeID-$firstName  
                                        $lastName-$specialization</option>";
                            }
                            else {
                                echo "<option value=$employeeID>$employeeID-$firstName  $lastName-
                ...
                <div class="formSection">
                    ...
                    <br>
                    <textarea id="reasonTextBox" name="reason" required><?php
                        echo $globalFetch["description"];
                    ?></textarea>
                    <br>
                </div>
                    ...
                    <div>
                        ...
                        <?php
                            if($globalFetch["appointmentStatus"] == "open") {
                                echo '<input type="radio" value="open" id="openRadioBtn" name="appointmentStatus" 
                                        checked required>';
                            }
                            else {
                                echo '<input type="radio" value="open" id="openRadioBtn" name="appointmentStatus" 
                        ...
                        <?php
                            if($globalFetch["appointmentStatus"] == "close") {
                                echo '<input type="radio" value="close" id="closeRadioBtn" name="appointmentStatus" 
                                        checked required>';
                            }
                            else {
                                echo '<input type="radio" value="close" id="closeRadioBtn" name="appointmentStatus" 
