...
<main class="app-main">
    ...
    <div class="container">
        <form action="../controllers/updateExaminationHandler.php?ID=<?php echo $examID;?>
            &examName=<?php echo $globalFetch['name']?>" method="POST" autocomplete="off">
            <div id="mainSection">
                <div class="formSection">
                    <label class="inputLabel" for="examNameTextBox">Name</label>
                    <br>
                    <input type="text" id="examNameTextBox" name="examName" value="<?php
                ...
                <div class="formSection">
                    ...
                    <br>
                    <input type="text" id="examOutcomeTextBox" name="examOutcome" value="<?php
